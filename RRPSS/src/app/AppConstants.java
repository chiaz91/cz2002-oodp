...
public interface AppConstants {
	...
	final String APP_VERSION = "0.3.3"; // release.feature changes.bug fix
...
//	final int LENGTH_STAFF_ID	 		= 10;
//	final int LENGTH_STAFF_NAME 		= 15;
//	final int LENGTH_STAFF_JOB_TITLE	= 15;
	final int LENGTH_MENU_ITEM_TYPE 	= 10;
	final int LENGTH_MENU_ITEM_ID	 	= 3;
	final int LENGTH_MENU_ITEM_NAME 	= 15;
	final int LENGTH_MENU_ITEM_DESC 	= 40;
