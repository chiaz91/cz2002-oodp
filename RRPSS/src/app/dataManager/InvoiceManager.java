...
public class InvoiceManager implements AppConstants{
	...
	public void addInvoice(Invoice invoice) {
		if(!this.invoices.contains(invoice)){
			...
			if (IS_TESTING) {
				System.out.println("[Test] Add: invoice has already exist");
			}
		}
	}
	...
	public void removeInvoice(Invoice invoice) {
		if(this.invoices.contains(invoice)){
			...
			if (IS_TESTING) {
				System.out.println("[Test] Remove: invoice does not exist");
			}
		}
	}
